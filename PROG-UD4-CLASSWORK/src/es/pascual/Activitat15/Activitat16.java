...
import es.pascual.Activitat14.Activitat15;
...
public class Activitat16 {
    ...
    public static void casSuma(){
        ...
        int op1 = llegirEnter();
        int op2 = llegirEnter();
        es.pascual.Activitat14.Activitat15.mostrarSuma(op1, op2);
    }
    public static void casResta(){
        System.out.print("Introduïsca els operants esquerra i dreta: ");
        int op1 = llegirEnter();
        int op2 = llegirEnter();
        es.pascual.Activitat14.Activitat15.mostrarResta(op1, op2);
    }
    public static void casMultiplicacio(){
        System.out.print("Introduïsca els operants esquerra i dreta: ");
        int op1 = llegirEnter();
        int op2 = llegirEnter();
        es.pascual.Activitat14.Activitat15.mostrarMultiplicacio(op1, op2);
    }
    public static void casDivisio(){
        System.out.print("Introduïsca els operants esquerra i dreta: ");
        int op1 = llegirEnter();
        int op2 = llegirEnter();
        es.pascual.Activitat14.Activitat15.mostrarDivisio(op1, op2);
    }
    public static void casAreaRecatangle(){
        System.out.print("Introduïsca els operants esquerra i dreta: ");
        int op1 = llegirEnter();
        int op2 = llegirEnter();
        es.pascual.Activitat14.Activitat15.mostrarAreaRectangle(op1, op2);
    }
    public static void casaAreaVolumPrisma(){
        System.out.print("Introduïsca el valor de les tres dimensions: ");
        int op1 = llegirEnter();
        int op2 = llegirEnter();
        int op3 = llegirEnter();
        es.pascual.Activitat14.Activitat15.mostrarAreaVolumPrisma(op1, op2, op3);
    }

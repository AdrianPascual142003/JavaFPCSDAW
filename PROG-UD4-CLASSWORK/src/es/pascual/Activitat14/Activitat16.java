...
public class Activitat16 {
    ...
    public static double llegirEnterDouble(){
        do {
            if (teclat.hasNextDouble()){
                return teclat.nextFloat();
            }else {
                teclat.next();
            }
        }while (true);
    ...
    public static void casAreaRecatangle(){
        ...
        double base = llegirEnterDouble();
        double altura = llegirEnterDouble();
        Activitat15.mostrarAreaRectangle(base,altura);
    }
    public static void casAreaVolumPrisma(){
        System.out.print("Introduïsca el valor de les tres dimensions: ");
        double op1 = llegirEnterDouble();
        double op2 = llegirEnterDouble();
        double op3 = llegirEnterDouble();

...
public class Activitat5b {
    ...
    public static void main(String[] args) {
        ...
        if (desfet < PLASTIC || desfet > ALTRES){
            System.out.println("Opció invalida");
        }else if (desfet == PLASTIC){
            System.out.println("Llançau al conetenidor groc");
        }else if (desfet == ORGANIC){
            System.out.println("Llançau al conetenidor gris");
        }else if (desfet == PAPER || desfet == CARTRO){
            System.out.println("Llançau al conetenidor blau");
        }else {
            System.out.println("Llançau al conetenidor verd");
        }

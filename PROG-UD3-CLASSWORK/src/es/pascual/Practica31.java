...
public class Practica31 {
    ...
    public static final String FREEZER = NEGRE + "                                       *,/                                      \n" +
            ...
            " @@%/@@@@@@@@%####%,/(/#/ %%%./%&&&&&&&&%#((#%&&&/,  /####/,%##(%.@@@@@@&%%%### \n" +
            " @@&@@@@@@@@%%# .@@@@@@@@@@@& /&&&%,,..,&&*,,,,...,(%@@@@@@@%%%#% @@@@@@@@%%####";
    public static final String ACABAR = "Adeu";
    public static final String PEDRE = "Malauradament, la aventura ha acabat i el món torna a ser un lloc\n" +
            "insegur. Una llàstima!";
    public static final String GUANYAR = "Enhorabona!! Heu aconseguit les 7 boles de Drac. El món torna a\n" +
            "respirar tranquil. Fins un altra amics!";
    ...
    public static void main(String[] args) {
        ...
        //DISTANCIA CASA GOKU A CASA SATAN
        ...
        int mcmBolaB4 = bolaB4;
        int mcmBolaB5 = bolaB5;
        int mcmBolaB6 = bolaB6;
        int mcmBolaB7 = bolaB7;
        int minComunMulti = 1;
        int divisorNivell5 = 2;
        while (divisorNivell5 <= mcmBolaB4 || divisorNivell5 <= mcmBolaB5 || divisorNivell5 <= mcmBolaB6 || divisorNivell5 <= mcmBolaB7){
            if (mcmBolaB4 % divisorNivell5 == 0 || mcmBolaB5 % divisorNivell5 ==0 || mcmBolaB6 % divisorNivell5 == 0 || mcmBolaB7 % divisorNivell5 == 0){
                minComunMulti *= divisorNivell5;
            }
            if (mcmBolaB4 % divisorNivell5 == 0) {
                mcmBolaB4 /= divisorNivell5;
            }
            if (mcmBolaB5 % divisorNivell5 == 0) {
                mcmBolaB5 /= divisorNivell5;
            }
            if (mcmBolaB6 % divisorNivell5 == 0){
                mcmBolaB6 /= divisorNivell5;
            }
            if (mcmBolaB7 % divisorNivell5 == 0){
                mcmBolaB7 /= divisorNivell5;
            }
            else {
                divisorNivell5++;
            }
        ...
        if (respuestaNivell5 == minComunMulti){
            System.out.println("\n\nHas encertat el resultat del mínim comú múltlípe, que es " + minComunMulti+ ".\n\n\n" );
        }else {
            System.out.println(PEDRE);
            return;
        }
        ...
        System.out.println(FREEZER);
        System.out.println(NEGRE + "\nFreezer" + NORMAL + ": Aquesta volta he perdut, a la proxima no pedré\n");

        System.out.println("HAS CONSEGUIT LES BOLES " + NEGRE + " "+ bolaB1 + ", " + bolaB2 + ", " + bolaB3 + ", " + bolaB4 + ", " + bolaB5 + ", " + bolaB6 + ", " + bolaB7);
        System.out.println(GUANYAR);

        System.out.println(GOKU);
        System.out.println(CIAN + "Son Goku:" + NORMAL + " Ho he aconseguit, aquesta volta no ten ixiràs amb la teua freezer");
